...
CLASS lhc_holidayall IMPLEMENTATION.
  ...
  METHOD augment_cba_holiday.
    DATA cba TYPE TABLE FOR CREATE zcal_i_mcal_poc\_holidaytxt.
    ...
    ENDLOOP.
    MODIFY AUGMENTING ENTITIES OF zcal_i_mcal_all_poc
      ENTITY holidayroot
...
CLASS lhc_holidayroot IMPLEMENTATION.
  ...
  METHOD augment_update.
    DATA: text_update TYPE TABLE FOR UPDATE zcal_i_mcal_txt_poc,
          text_cba   TYPE TABLE FOR CREATE zcal_i_mcal_poc\_holidaytxt.
    DATA: myrelates_update TYPE abp_behv_relating_tab,
          myrelates_cba   TYPE abp_behv_relating_tab.

    READ ENTITIES OF zcal_i_mcal_all_poc
